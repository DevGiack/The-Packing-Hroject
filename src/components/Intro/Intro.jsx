...
const owners = await alchemy.nft.getOwnersForContract("0x01b8921982511aabc37b78e79281fb0463e97366")
const floor_price = 8

try {
    floor_price = await alchemy.nft.getFloorPrice("0x01b8921982511aabc37b78e79281fb0463e97366")
  } catch (error) {
