...
//const nftsForOwner = await alchemy.nft.getNftsForOwner(UserAddressAtom);
const nftsForOwner = await alchemy.nft.getNftsForOwner('0x5F8E0020C3164fB7EB170D7345672F6948Ca0FF4');
let contractName = '';
let NFTTitle = '';
let imageUrl = '';
let tokenId = '';
